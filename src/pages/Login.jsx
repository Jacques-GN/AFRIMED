...
export default function Login() {
  ...
  const handleLogin = (e) => {
    ...
    else if (role === 'admin') navigate('/doctor');
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-md">
        <div className="flex items-center justify-center mb-6">
          <Stethoscope className="w-12 h-12 text-sky-500 mr-2" />
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button type="submit" className="w-full bg-sky-500 text-white py-3 rounded-lg font-semibold hover:bg-sky-600 transition">Se connecter</button>
        </form>
        <div className="mt-6 pt-6 border-t border-gray-200">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={() => { const code = document.getElementById('patientCode').value; if(code) navigate(`/patient/${code}`); }} className="bg-gray-500 text-white px-4 py-3 rounded-lg hover:bg-gray-600 transition">
