  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white shadow-sm p-4 flex justify-between items-center">
        <h1 className="text-xl font-bold text-primary">AFRIMED - Espace Médecin</h1>
        <button onClick={() => navigate('/login')} className="flex items-center text-gray-600 hover:text-danger">
      ...
      <main className="p-6 max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-primary">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-500 text-sm">Consultations aujourd'hui</p>
                <p className="text-3xl font-bold">8</p>
              </div>
              <Users className="w-10 h-10 text-primary opacity-50" />
            </div>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-success">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-500 text-sm">Résultats labo reçus</p>
                <p className="text-3xl font-bold">{pendingLabs}</p>
              </div>
              <Activity className="w-10 h-10 text-success opacity-50" />
            </div>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-orange-400">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-500 text-sm">Suivis en retard</p>
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <button 
            ...
            className="bg-primary text-white px-4 py-2 rounded-lg flex items-center hover:bg-sky-600 transition"
          >
