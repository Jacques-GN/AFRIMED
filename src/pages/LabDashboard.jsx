...
export default function LabDashboard() {
  ...
  const handleValidate = (id) => {
    setRequests(requests.map(r => 
      r.id === id ? { ...r, status: 'Terminé', results: resultText } : r
    ));
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white shadow-sm p-4 flex justify-between items-center">
        <h1 className="text-xl font-bold text-primary">AFRIMED - Espace Laboratoire</h1>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
            <div className="bg-white p-6 rounded-xl shadow-lg w-full max-w-md">
              ...
              <textarea 
                ...
                className="w-full p-3 border border-gray-300 rounded-lg mb-4" rows="4" placeholder="Saisir les résultats ici..."
              />
              <div className="flex justify-end gap-3">
                ...
                <button onClick={() => handleValidate(selectedRequest.id)} className="px-4 py-2 bg-success text-white rounded-lg flex items-center hover:bg-green-600">
