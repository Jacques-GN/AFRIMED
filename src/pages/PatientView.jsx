    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
        <div className="bg-white p-8 rounded-xl shadow-lg text-center max-w-md w-full">
          <h2 className="text-xl font-bold text-danger mb-2">Code invalide</h2>
          ...
          <button onClick={() => navigate('/login')} className="text-primary hover:underline">Retour à l'accueil</button>
        </div>
      </div>
    );
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-xl shadow-sm">
            <h3 className="font-semibold text-gray-800 mb-4 flex items-center">
              <FileText className="w-5 h-5 mr-2 text-primary" /> Informations médicales
            </h3>
            <div className="space-y-3 text-sm">
              <div>
                <span className="text-gray-500 block">Allergies</span>
                <span className="font-medium text-danger">{patient.allergies}</span>
              </div>
              <div>
                <span className="text-gray-500 block">Antécédents</span>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm">
            <h3 className="font-semibold text-gray-800 mb-4 flex items-center">
              <Calendar className="w-5 h-5 mr-2 text-primary" /> Dernières prescriptions
            </h3>
            <div className="space-y-3">
              <div className="border-l-4 border-primary pl-3 py-1">
                ...
                <button className="text-primary text-xs mt-2 hover:underline">Télécharger l'ordonnance (PDF)</button>
              </div>
            </div>
          </div>
        </div>
